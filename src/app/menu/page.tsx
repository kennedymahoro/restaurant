...
export default function Menu(){
  ...
  return (
    <div className="">
      <Navbar />
      <section className=" mt-48 mb-60 mx-5">
        <h1 className="text-5xl font-thinman tracking-wider mt-5">Menu</h1>
        <p className="font-crimson text-sm my-6">We're serving a multi-course dining experience where you choose three of the courses (and we like to surprise you with several others).</p> 
      ...
      <hr className="divide-solid divide-y-4 w-9/12  m-9 divide-black" />
      ...
      <div className="text-xs mx-4 my-10 font-crimson">
